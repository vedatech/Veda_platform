    ...
    "includes" =>
        {
            ...
            "crypto/engine/gost89.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_ameth.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_asn1.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_crypt.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_ctl.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_ec_keyx.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_ec_sign.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_eng.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_grasshopper_cipher.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_grasshopper_core.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_grasshopper_defines.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_grasshopper_galois_precompiled.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_grasshopper_mac.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_grasshopper_precompiled.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_keywrap.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_md.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_md2012.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_params.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gost_pmeth.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gosthash.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
                ],
            "crypto/engine/gosthash2012.o" =>
                [
                    ".",
                    "crypto/include",
                    "include",
    ...
    "sources" =>
        {
            ...
            "crypto/engine/gost89.o" =>
                [
                    "crypto/engine/gost89.c",
                ],
            "crypto/engine/gost_ameth.o" =>
                [
                    "crypto/engine/gost_ameth.c",
                ],
            "crypto/engine/gost_asn1.o" =>
                [
                    "crypto/engine/gost_asn1.c",
                ],
            "crypto/engine/gost_crypt.o" =>
                [
                    "crypto/engine/gost_crypt.c",
                ],
            "crypto/engine/gost_ctl.o" =>
                [
                    "crypto/engine/gost_ctl.c",
                ],
            "crypto/engine/gost_ec_keyx.o" =>
                [
                    "crypto/engine/gost_ec_keyx.c",
                ],
            "crypto/engine/gost_ec_sign.o" =>
                [
                    "crypto/engine/gost_ec_sign.c",
                ],
            "crypto/engine/gost_eng.o" =>
                [
                    "crypto/engine/gost_eng.c",
                ],
            "crypto/engine/gost_grasshopper_cipher.o" =>
                [
                    "crypto/engine/gost_grasshopper_cipher.c",
                ],
            "crypto/engine/gost_grasshopper_core.o" =>
                [
                    "crypto/engine/gost_grasshopper_core.c",
                ],
            "crypto/engine/gost_grasshopper_defines.o" =>
                [
                    "crypto/engine/gost_grasshopper_defines.c",
                ],
            "crypto/engine/gost_grasshopper_galois_precompiled.o" =>
                [
                    "crypto/engine/gost_grasshopper_galois_precompiled.c",
                ],
            "crypto/engine/gost_grasshopper_mac.o" =>
                [
                    "crypto/engine/gost_grasshopper_mac.c",
                ],
            "crypto/engine/gost_grasshopper_precompiled.o" =>
                [
                    "crypto/engine/gost_grasshopper_precompiled.c",
                ],
            "crypto/engine/gost_keywrap.o" =>
                [
                    "crypto/engine/gost_keywrap.c",
                ],
            "crypto/engine/gost_md.o" =>
                [
                    "crypto/engine/gost_md.c",
                ],
            "crypto/engine/gost_md2012.o" =>
                [
                    "crypto/engine/gost_md2012.c",
                ],
            "crypto/engine/gost_params.o" =>
                [
                    "crypto/engine/gost_params.c",
                ],
            "crypto/engine/gost_pmeth.o" =>
                [
                    "crypto/engine/gost_pmeth.c",
                ],
            "crypto/engine/gosthash.o" =>
                [
                    "crypto/engine/gosthash.c",
                ],
            "crypto/engine/gosthash2012.o" =>
                [
                    "crypto/engine/gosthash2012.c",
                ],
            "crypto/engine/tb_asnmth.o" =>
                [
